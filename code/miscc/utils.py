...
def drawCaption(convas, captions, ixtoword, vis_size, off1=2, off2=2):
    ...
    fnt = ImageFont.truetype('/home/e521/Desktop/wt024.ttf', 50)  #fnt = ImageFont.truetype('Pillow/Tests/fonts/FreeMono.ttf', 50)
    ...
    for i in range(num):
        ...
        for j in range(len(cap)):
            if cap[j] == 0:
                break
            word = ixtoword[cap[j]].encode('utf8', 'ignore').decode('utf8')  #ascii
