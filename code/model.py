...
from bohan import inceptionresnetV2
...
class CNN_ENCODER(nn.Module):
    ...
    def define_module(self, model):
        ...
        self.repeat = nn.Sequential(
            inceptionresnetV2.Block35(scale=0.17),
            inceptionresnetV2.Block35(scale=0.17),
            inceptionresnetV2.Block35(scale=0.17),
            inceptionresnetV2.Block35(scale=0.17),
            inceptionresnetV2.Block35(scale=0.17),
        ...
        self.repeat_1 = nn.Sequential(
            inceptionresnetV2.Block17(scale=0.10),
            inceptionresnetV2.Block17(scale=0.10),
            inceptionresnetV2.Block17(scale=0.10),
            inceptionresnetV2.Block17(scale=0.10),
            inceptionresnetV2.Block17(scale=0.10),
        ...
        self.repeat_2 = nn.Sequential(
            inceptionresnetV2.Block8(scale=0.20),
            inceptionresnetV2.Block8(scale=0.20),
            inceptionresnetV2.Block8(scale=0.20),
            inceptionresnetV2.Block8(scale=0.20),
            inceptionresnetV2.Block8(scale=0.20),
        ...
        self.conv2d_7b = inceptionresnetV2.BasicConv2d(2080, 1536, kernel_size=1, stride=1)
        self.avgpool_1a = nn.AvgPool2d(8, count_include_pad=False)
        #self.last_linear = nn.Linear(1536, 1001)

        self.emb_features = conv1x1(1088, self.nef)
        self.emb_cnn_code = nn.Linear(1536, self.nef)
